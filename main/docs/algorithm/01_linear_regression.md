...
<div class="color-area">
    <ol>
        <li style="background-color:#ffbcbc">#ffbcbc -大学数学レベル3-</li>
        <li style="background-color:#ffbcdd">#ffbcdd -大学数学レベル2-</li>	
        <li style="background-color:#ffbcff">#ffbcff　↑</li>
        <li style="background-color:#ddbcff">#ddbcff　↑</li>
        <li style="background-color:#bcbcff">#bcbcff -理系大学入試レベル-</li>
        <li style="background-color:#bcddff">#bcddff　↑</li>
        <li style="background-color:#bcffff">#bcffff　↑</li>
        <li style="background-color:#bcffdd">#bcffdd -高校数学レベル-</li>
        <li style="background-color:#bcffbc">#bcffbc　↑</li>
        <li style="background-color:#ddffbc">#ddffbc　↑</li>
        <li style="background-color:#ffffbc">#ffffbc -中学数学レベル-</li>
    </ol>
</div>
数式の記述法  
{% math %}
